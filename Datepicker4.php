...
$(function(){
  ...
  datepicker_option.showOn = "button";
  datepicker_option.buttonText = "開く";

  $("#<?= $field_id ?>").datepicker( datepicker_option );

  $(".ui-datepicker-trigger").addClass("btn btn-primary ms-2");
...
<body>
<h1 class="alert alert-primary"><a href=".">ボタンで開く</a></h1>
